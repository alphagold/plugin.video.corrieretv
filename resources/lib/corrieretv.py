...
class CorriereTV:
    ...
    __BaseUrl = "https://video.corriere.it"
    ...
    def getChannels(self):
        ...
        for item in list:
            ...
            if channel["url"] == "https://video.corriere.it/archivio/":
                continue
    ...
    def getVideoByChannel(self, pageUrl):
        ...
        match = re.search(r"channel\s*=\s*({[^;]+});", str(script), re.DOTALL)
        ...
        for article in articles:
            video = {}
            video["videoId"] = str(article["class"])[-38:-2]
